...
slug: "ai-commerce-intelligence"
summary: "Customer segmentation and explainable value analysis over the Olist e-commerce dataset — which started as a prediction project and became an explanation project once data leakage surfaced."
techStack: ["Python", "Pandas", "Scikit-Learn", "XGBoost", "SHAP", "Plotly", "Streamlit"]
featured: false
order: 4
status: "shipped"
repo: "https://github.com/shourya-tiwari/AI-Commerce-Intelligence-Platform"
metrics:
  - { label: "customer personas", value: "5" }
  - { label: "customers who buy once", value: "96%" }
---
